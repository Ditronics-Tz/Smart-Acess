...
from .views import SecurityPersonnelCreateView, SecurityPersonnelListView, SecurityPersonnelDetailView, SecurityPersonnelUpdateView, SecurityPersonnelDeleteView
