...
urlpatterns = [
    ...
    path('api/administrator/security-personnel/<uuid:security_id>/update/', SecurityPersonnelUpdateView.as_view(), name='security-personnel-update'),  # PUT & PATCH by ID (used independtly)
]